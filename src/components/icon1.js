...
const Icon1 = (props) => {
  return (
    <div
      ...
      className={`icon1-container ${props.rootClassName} `}
    >
      {props.type === 'repeat' && (
        <svg className="icon-component">
          <path
            d="M7 23L3 19L7 15"
            stroke-width="2"
      ...
      {props.type === 'logo-portswigger' && (
        <svg className="icon1-icon2247 icon-component">
      ...
      {props.type === 'logo-burp-suite' && (
        <svg className="icon1-icon2254 icon-component">
      ...
      {props.type === 'logo-enterprise' && (
        <svg className="icon1-icon2261 icon-component">
      ...
      {props.type === 'logo-pro' && (
        <svg className="icon1-icon2268 icon-component">
      ...
      {props.type === 'logo-community' && (
        <svg className="icon1-icon2275 icon-component">
      ...
      {props.type === 'logo-charm' && (
        <svg className="icon1-icon2282 icon-component">
      ...
      {props.type === 'logo-web-security-academy' && (
        <svg className="icon1-icon2292 icon-component">
      ...
      {props.type === 'twitter' && (
        <svg className="icon1-icon2299 icon-component">
      ...
      {props.type === 'discord' && (
        <svg className="icon1-icon2301 icon-component">
          <path
      ...
      {props.type === 'app-security' && (
        <img
          src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/08f747ed-00a5-4c49-bf33-6ab4b22224ae/b6b0c5b6-9405-4b11-8d6d-0c86b471861b?org_if_sml=1971&amp;force_format=original"
          className="icon1-image1"
        />
      )}
      {props.type === 'catch-bugs' && (
        <img
          src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/08f747ed-00a5-4c49-bf33-6ab4b22224ae/9b7d33c0-5013-468e-866b-dfc7f99a01eb?org_if_sml=13132&amp;force_format=original"
          className="icon1-image2"
        />
      )}
      ...
      {props.type === 'attack' && (
        <img
          src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/08f747ed-00a5-4c49-bf33-6ab4b22224ae/c42ac31b-eae1-4f3a-96e6-da82c2aecf05?org_if_sml=12929&amp;force_format=original"
          className="icon1-image5"
        />
      )}
      {props.type === 'report' && (
        <img
          src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/08f747ed-00a5-4c49-bf33-6ab4b22224ae/e5218056-0539-433a-8e9e-d6c15d44f20e?org_if_sml=13608&amp;force_format=original"
          className="icon1-image6"
        />
      )}
    </div>
  )

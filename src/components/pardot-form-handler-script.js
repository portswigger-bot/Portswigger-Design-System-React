...
import './pardot-form-handler-script.css'

const PardotFormHandlerScript = (props) => {
  return (
    <div
      className={`pardot-form-handler-script-container1 ${props.rootClassName} `}
    >
      <div className="pardot-form-handler-script-container2">
        <div className="pardot-form-handler-script-container3">
          <Script
            html={`<script>
...
PardotFormHandlerScript.defaultProps = {
  rootClassName: '',
}

PardotFormHandlerScript.propTypes = {
  rootClassName: PropTypes.string,
}

export default PardotFormHandlerScript

...
import './pardot-form-handler-script2.css'

const PardotFormHandlerScript2 = (props) => {
  return (
    <div
      className={`pardot-form-handler-script2-container1 ${props.rootClassName} `}
    >
      <div className="pardot-form-handler-script2-container2">
        <div className="pardot-form-handler-script2-container3">
          <Script
            html={`<script>
...
PardotFormHandlerScript2.defaultProps = {
  rootClassName: '',
}

PardotFormHandlerScript2.propTypes = {
  rootClassName: PropTypes.string,
}

export default PardotFormHandlerScript2
